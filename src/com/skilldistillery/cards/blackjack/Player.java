...
//	public Player player = new Player();
	...
	public String hitOrStand(Scanner sc, Card i) {
		String hitInput = "S";
		System.out.println("Your total is currently " + this.playerHand.calculateHandValue(i));
		if (this.playerHand.calculateHandValue(i) > 21) {
			System.out.println("You busted! Better luck next time ");
		} else if (this.playerHand.calculateHandValue(i) == 21){
